...
12:08:31.472  Node 1 connects to external peer (198.51.100.1:40303)
...
12:08:55.517  Node 2 connects to external peer (198.51.100.1:40303)
```

### External Peer

Both nodes connected to an external peer at `198.51.100.1:40303`. This peer may be contributing to the fork issues (see Section 5).
...
The external peer at `198.51.100.1:40303` may be:
