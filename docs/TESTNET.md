...
```
/ip4/72.60.228.233/tcp/40303/p2p/12D3KooWCKTKPZWVREhd1XBem2eoFcYVFxJRid87WCij95heprha
/ip4/72.60.228.233/tcp/40304/p2p/12D3KooWKfg37CcNfgoWvCpm4xNCGB9uTQgRzjS6v6NYgUqQ1Nbr
```
...
./target/release/doli-node --network testnet run \
    --bootstrap /ip4/72.60.228.233/tcp/40303/p2p/12D3KooWCKTKPZWVREhd1XBem2eoFcYVFxJRid87WCij95heprha
```
...
# ExecStart=/home/YOUR_USERNAME/doli/target/release/doli-node --network testnet run --bootstrap /ip4/72.60.228.233/tcp/40303/p2p/12D3KooWCKTKPZWVREhd1XBem2eoFcYVFxJRid87WCij95heprha
...
2. Verify port is open: `nc -zv 72.60.228.233 40303`
