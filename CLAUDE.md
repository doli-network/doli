...
**3 servers.** ai1=198.51.100.1, ai2=198.51.100.2, ai3=198.51.100.3 (seeds only, no SSH to ai1/ai2). Mainnet/testnet = separate binaries. ai3 easy to forget on chain resets.
