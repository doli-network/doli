...
echo ""
echo "v${VERSION_BARE} is still a DRAFT: no node can see it yet (INC-I-202)."
echo "Next: ./scripts/publish-release.sh ${VERSION_BARE} verifies the signatures and promotes it."
