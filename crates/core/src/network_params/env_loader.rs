...
pub(super) fn load_from_env(network: Network) -> NetworkParams {
    ...
    NetworkParams {
        ...
        inc_i_193_attestor_refill_activation_height: if is_mainnet {
            defaults.inc_i_193_attestor_refill_activation_height
        } else {
            env_parse(
                "DOLI_INC_I_193_ATTESTOR_REFILL_ACTIVATION_HEIGHT",
                defaults.inc_i_193_attestor_refill_activation_height,
            )
        },
