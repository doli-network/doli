    ...
    pub fn defaults(network: Network) -> NetworkParams {
        ...
        match network {
            Network::Mainnet => NetworkParams {
                ...
                veto_period_secs: 600, // TEMPORARY: 10 min for E2E retest (prod: 2 * 3600)
                grace_period_secs: 60,  // TEMPORARY: 1 min for E2E retest (prod: 3600)
                ...
                update_check_interval_secs: 30, // TEMPORARY: 30s for E2E retest (prod: 6 * 3600)
