...
| P4 | Key-rotation decision recorded (O5): rotation TxType shipped, or written acceptance that key loss = permanent removal | **decision recorded 2026-09-11 — superseded by `bls-key-rotation-requirements.md` (rotation TxType branch); closes on merge of that feature.** Census: 2 mainnet producers mismatched and earning 0, 33 of 93 active latently exposed (`docs/.workflow/bls-mismatch-census-2026-09-11.md`) |
