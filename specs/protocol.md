...
on testnet and on devnet (`crates/core/src/network_params/defaults.rs`). No
...
mainnet, on testnet and on devnet, so no rotation can enter a block until a future binary
