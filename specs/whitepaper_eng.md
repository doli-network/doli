...
1. NTP servers
2. Median offset from connected peers
...
Selection uses deterministic round-robin, not probabilistic lottery:
...
All producers earn the same percentage return. More bonds means more absolute return, same ROI percentage.
...
1. 100% of bond burned permanently
2. Immediate exclusion from producer set
3. To reactivate: new registration with T_registration × 2
