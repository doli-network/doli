...
| REQ-ROT-013 | Must | `bins/cli/tests/it/inc_i_217_m10_rotate_bls_golden.rs` (21 tests) — `auth_message_reproduces_the_m4_golden_digest`, `auth_message_is_bound_to_the_outpoint_it_spends`, `payload_is_exactly_240_bytes_and_round_trips_through_the_core_codec`, `producer_signature_verifies_against_the_digest_the_cli_reports`, `transaction_is_one_input_one_normal_output_and_reveals_the_producer_key`, `input_signature_verifies_under_signing_message_for_input_zero`, `built_transaction_passes_rotate_stateless_above_the_gate_and_is_gated_below_it`, `accepts_a_registered_producer_whose_wallet_key_differs_and_has_no_pending_rotation`, `refuses_when_the_wallet_key_already_equals_the_onchain_key`, `refuses_when_a_rotation_is_already_pending`, `refuses_when_the_wallet_has_no_bls_key`, `refuses_when_the_producer_is_not_registered`, `fee_pays_for_the_240_byte_payload`, `selects_the_smallest_utxo_that_strictly_covers_the_fee_whatever_the_input_order`, `refuses_when_no_single_utxo_strictly_covers_the_fee`, `notice_states_the_irreversibility_and_the_boundary_effect`, `consent_is_never_assumed_without_a_terminal_and_without_yes`, `only_an_affirmative_answer_is_consent`, `report_shows_the_old_key_the_new_key_the_fee_and_the_effective_height`, `no_report_line_and_no_notice_contains_either_secret`, `a_rejected_secret_is_never_echoed_in_the_error`; `bins/cli/tests/it/inc_i_217_m10_wallet_untouched.rs::inc_i_217_rotate_bls_leaves_the_wallet_byte_identical` (process-boundary tripwire) | Module 7 (CLI) | M10 — `bins/cli/src/rotate_tx.rs` (new, pure: notice, preconditions, fee, UTXO choice, tx build, report, consent) + `bins/cli/src/cmd_producer/rotate.rs` (new, RPC/print half); wiring in `bins/cli/src/lib.rs`, `bins/cli/src/commands.rs`, `bins/cli/src/cmd_producer/{mod,dispatch}.rs`; DTO fields in `bins/cli/src/rpc_client.rs` (`blsPubkey`, `newBlsPubkey`, `effectiveAtHeight`) |
